...
#define DESC_ENABLE_NODE_POWER_CONTROL                  /*Add by LT, for KC-2 Sleep request,20160712*/
/* In general use default session monitoring */
#define DESC_ENABLE_DEFAULT_SESSION_SLEEP_PREVENTION    /*Add by LT, for KC-2 Sleep request,20160712*/
...
#define DESC_ENABLE_ATT_CNTR_RESET_ON_KEY_OK   //#define DESC_DISABLE_ATT_CNTR_RESET_ON_KEY_OK,LT modify for Geely SPEC,20160606
/* Seed protection by seed repetition will be supported. */
#define DESC_ENABLE_USE_OLD_SEED_PROTECTION
...
#define DESC_PUBLIC_INTERFACE_MAGIC_NUMBER                           10035
...
#define kDescNrcpositive_response                                    0x00
...
#define kDescNrcNo_response_from_subnet_component                    0x25
#define kDescNrcFailure_prevents_execution_of_requested_action       0x26
...
/* Convert uS->ms and then divide */         
#define kDescNpmTimerTicks                                           (vuint16)(5000/(kDescCallCycleUs/1000)) /*Add by LT for NM sleep request for KC-2,20160712*/

/* P2 timeout in DescTask cycles. */
#define kDescP2Ticks                                                 4
/* P2Ex timeout in DescTask cycles. */
#define kDescP2StarTicks                                             199//499 /*Modify for Geely spec,LT 20160605*/
/* P2 timeout time in 1ms resolution. */
#define kDescTimeValueP2                                             50
/* P2Ex timeout time in 10 ms resolution. */
#define kDescTimeValueP2Star                                         200//500 /*Modify for Geely spec,LT 20160605*/
...
#define kDescNumStateSecurityAccess                                  6
#define kDescStateSecurityAccessLocked                               ((DescStateGroup)0x01)
#define kDescStateSecurityAccessUnlockedL1                           ((DescStateGroup)0x02)
#define kDescStateSecurityAccessUnlocked_Flash                       ((DescStateGroup)0x04)
#define kDescStateSecurityAccessUnlocked_Level_2                     ((DescStateGroup)0x08)
#define kDescStateSecurityAccessUnlockedL11                          ((DescStateGroup)0x10)
