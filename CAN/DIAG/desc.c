/* -----------------------------------------------------------------------------
  ...
  Description: Implementation of CANdesc.
                ...
                Manufacturer: BAIC
                EcuDocFile:   D:\HVACProject\Geely\KC_2\Gney\Geely_KC-2_012.cdd
                Variant:      CommonDiagnostics

  Generated by CANdelaGen, Mon Aug 08 18:27:48 2016
...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             10035
...
#define kDescStateGroupNumTransition                                  4
...
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         48
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  131
/* Context modes */
...
#define kDescOemNrcTooManyPIDs                                       kDescNrcInvalidFormat//kDescNrcRequestOutOfRange/*Li Jiaye modify for Geely*/
...
{
  DescStateGroup stateSecurityAccess : 5;
...
static void DESC_API_CALLBACK_TYPE DescOemControlDefault(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemControlProgramming(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemControlExtendedDiagnostic(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescReadDataByIdentifier(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemRequestrequestSeed_to_reach_security_level_Unlocked_Level_1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSend_KeysendKey_to_reach_security_level_Unlocked_Level_1(DescMsgContext* pMsgContext);
...
static void DESC_API_CALLBACK_TYPE DescOemControldisableRxAndTx(DescMsgContext* pMsgContext);
...
static void DescOemFunReqDisNRC(void);
...
static vuint8				g_descSecureTimerFlag=False;/*Li Jiaye for Geely Only*/
#endif
...
{
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x07, 0x00,  2,  0,  0 } /* $10 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x06, 0x00,  2,  3,  3 } /* $11 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0, 0x05, 0x00,  1,  5,  5 } /* $14 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x05, 0x00,  2,  6,  5 } /* $19 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0, 0x07, 0x00,  1, 10,  9 } /* $22 */, 
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 1, 0x04, 0x00,  2, 11,  9 } /* $27 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x04, 0x00,  2, 13, 11 } /* $28 */, 
  { 0x07, 2, 2, 0x03, 0x03, 0, 1, 0, 0, 0x04, 0x00,  4, 16, 14 } /* $2E */, 

  { 0x0F, 3, 2, 0x01, 0x01, 0, 0, 0, 0, 0x04, 0x00,  4, 25, 32 } /* $2F */, 
  { 0x0D, 3, 3, 0x01, 0x01, 1, 1, 0, 1, 0x04, 0x00,  4, 43, 122 } /* $31 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x07, 0x00,  2, 45, 128 } /* $3E */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x04, 0x00,  2, 46, 129 } /* $85 */, 
  { 0x00, 0, 0, 0x00, 0x00, 0, 1, 0, 0, 0x00, 0x00,  1, 48, 131 } /* $FF */
};
...
V_MEMROM0 static V_MEMROM1 DescPostHandler V_MEMROM2 g_descPostHandlerTable[kDescNumPostHandlers] = 
{
  ...
  ApplDescPostResethardReset, 
  ApplDescPostResetsoftReset
};
...
{
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 },                      0,    0, DescOemControlDefault } /* $10 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x06 },                      1,    0, DescOemControlProgramming } /* $10 $2 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x05 },                      2,    0, DescOemControlExtendedDiagnostic } /* $10 $3 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x06 }, kDescStateNoTransition,    3, ApplDescResethardReset } /* $11 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x06 }, kDescStateNoTransition,    4, ApplDescResetsoftReset } /* $11 $3 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x1F, 0x05 }, kDescStateNoTransition,    0, ApplDescClearFaultMemory } /* $14 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x1F, 0x05 }, kDescStateNoTransition,    0, ApplDescReadNumberFaultMemory } /* $19 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x1F, 0x05 }, kDescStateNoTransition,    0, ApplDescRead_DTC_by_status_maskFaultMemory } /* $19 $2 */, 

  {   6, { 0x03, 0x03, 0 }, { 0x1F, 0x05 }, kDescStateNoTransition,    0, ApplDescReadEnvironmentDataFaultMemory } /* $19 $4 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x05 }, kDescStateNoTransition,    0, ApplDescRead_supported_DTCFaultMemory } /* $19 $A */, 
  {   0, { 0x03, 0x03, 0 }, { 0x1F, 0x07 }, kDescStateNoTransition,    1, DescReadDataByIdentifier } /* $22 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    0, DescOemRequestrequestSeed_to_reach_security_level_Unlocked_Level_1 } /* $27 $1 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x1F, 0x04 },                      3,    0, DescOemSend_KeysendKey_to_reach_security_level_Unlocked_Level_1 } /* $27 $2 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    2, DescOemControlenableRxAndTx } /* $28 $0 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    2, DescOemControlenableRxAndDisableTx } /* $28 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    2, DescOemControldisableRxAndTx } /* $28 $3 */, 

  {  67, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteBackup_configuration_information } /* $2E $DF $EF */, 
  {   7, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteECUFunctionConfiguration } /* $2E $F1 $1 */, 
  {  11, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteVehicleNetworkConfigurationDataIdentifier } /* $2E $F1 $10 */, 
  {  11, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteVehicle_Name } /* $2E $F1 $12 */, 
  {  20, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteVehicleIdentificationNumber } /* $2E $F1 $90 */, 
  {  11, { 0x03, 0x03, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteSystemNameOrEngineType } /* $2E $F1 $97 */, 
  {  19, { 0x01, 0x01, 0 }, { 0x06, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteRepairShopCodeOrTesterSerialNumber } /* $2E $F1 $98 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x06, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteProgrammingOrConfigurationDate } /* $2E $F1 $99 */, 

  {   7, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescWriteECUInstallationDateDataIdentifier } /* $2E $F1 $9D */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetDriverTempActuator } /* $2F $63 $0 $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlDriverTempActuator } /* $2F $63 $0 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetLoopmode } /* $2F $63 $8 $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlLoopmode } /* $2F $63 $8 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetIONControl } /* $2F $63 $9 $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlIONControl } /* $2F $63 $9 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetBlower_Level } /* $2F $63 $B $0 */, 

  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlBlower_Level } /* $2F $63 $B $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetModeActuator } /* $2F $63 $C $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlModeActuator } /* $2F $63 $C $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetRearDefrostControl } /* $2F $63 $E $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlRearDefrostControl } /* $2F $63 $E $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetCompressorControl } /* $2F $63 $F $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlCompressorControl } /* $2F $63 $F $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetPassengerTempActuator } /* $2F $63 $12 $0 */, 

  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlPassengerTempActuator } /* $2F $63 $12 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_ResetTelltalePWMDutyControl } /* $2F $63 $1C $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescControlTelltalePWMDutyControl } /* $2F $63 $1C $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescStartSetUserSettingToDefalut } /* $31 $1 $63 $F0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x02, 0x04 }, kDescStateNoTransition,    0, ApplDescStartECUSelftest } /* $31 $1 $DF $F0 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 }, kDescStateNoTransition,    0, DescOemProcessTesterPresent } /* $3E $0 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_DTC_Setting_onControlDTCSetting } /* $85 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x04 }, kDescStateNoTransition,    0, ApplDescControl_DTC_Setting_offControlDTCSetting } /* $85 $2 */
};
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSvcInstHeadExt[kDescSvcInstHeadExtNumItems] = 
{
  ...
  0x01, 0x02 /* $27 */, 
  0x00, 0x01, 0x03 /* $28 */, 
  0xDF, 0xEF, 0xF1, 0x01, 0xF1, 0x10, 0xF1, 0x12, 0xF1, 0x90, 0xF1, 0x97, 0xF1, 0x98, 0xF1, 0x99 /* $2E */, 
  0xF1, 0x9D /* $2E */, 
  0x63, 0x00, 0x00, 0x63, 0x00, 0x63, 0x00, 0x03, 0x63, 0x00, 0x63, 0x08, 0x00, 0x63, 0x08, 0x63, 0x08, 0x03, 0x63, 0x08, 0x63, 0x09, 0x00, 0x63, 0x09, 0x63, 0x09, 0x03, 0x63, 0x09, 0x63, 0x0B, 0x00, 0x63, 0x0B /* $2F */, 

  0x63, 0x0B, 0x03, 0x63, 0x0B, 0x63, 0x0C, 0x00, 0x63, 0x0C, 0x63, 0x0C, 0x03, 0x63, 0x0C, 0x63, 0x0E, 0x00, 0x63, 0x0E, 0x63, 0x0E, 0x03, 0x63, 0x0E, 0x63, 0x0F, 0x00, 0x63, 0x0F, 0x63, 0x0F, 0x03, 0x63, 0x0F /* $2F */, 
  0x63, 0x12, 0x00, 0x63, 0x12, 0x63, 0x12, 0x03, 0x63, 0x12, 0x63, 0x1C, 0x00, 0x63, 0x1C, 0x63, 0x1C, 0x03, 0x63, 0x1C /* $2F */, 
  0x01, 0x63, 0xF0, 0x01, 0xDF, 0xF0 /* $31 */, 
  0x00 /* $3E */, 
  0x01, 0x02 /* $85 */
};
...
/* Each entry represents a reference to a challenge set. */
V_MEMROM0 static V_MEMROM1 vuint8 V_MEMROM2 g_descSeedLength[kDescNumStateSecurityAccess - 1] = 
{
  4, 
  0, 
  0, 
...
{
  { 0x0200,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadProgrammingCounter }, 
  { 0x0201,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadProgrammingAttempCounter }, 
  { 0x6300,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadDriverTempActuator }, 
  { 0x6301,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadInCarTemperature }, 
  { 0x6302,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadAmbientTemperature }, 
  { 0x6303,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadEvapTemperature }, 
  { 0x6306,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadInCarAirQuanlityStatus }, 
  { 0x6307,    2, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadInCarAirQuanlityValue }, 

  { 0x6308,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadLoopmode }, 
  { 0x6309,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadIONControl }, 
  { 0x630A,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadACWorkingState }, 
  { 0x630B,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadBlower_Level }, 
  { 0x630C,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadModeActuator }, 
  { 0x630D,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadDefrostState }, 
  { 0x630E,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadRearDefrostControl }, 
  { 0x630F,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadCompressorControl }, 

  { 0x6310,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadMAXA_CState }, 
  { 0x6311,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadDual_state }, 
  { 0x6312,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadPassengerTempActuator }, 
  { 0x6313,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadRecirculationActuator }, 
  { 0x6315,    2, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadDriver_side_Sunload_Value }, 
  { 0x6316,    2, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadPassenegr_side_Sunload_Value }, 
  { 0x6317,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadOutSideAirQuanlityStatus }, 
  { 0x6318,    2, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadOutSideAirQuanlityValue }, 

  { 0x6319,    2, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadAQSVoltage }, 
  { 0x631A,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadCoolantTemperature }, 
  { 0x631C,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadTelltalePWMDutyControl }, 
  { 0xDF00,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadECUSupplierVoltage }, 
  { 0xDF03,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadKL15status }, 
  { 0xDFEF,   64, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadBackup_configuration_information }, 
  { 0xF101,    4, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadECUFunctionConfiguration }, 
  { 0xF110,    8, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadVehicleNetworkConfigurationDataIdentifier }, 

  { 0xF112,    8, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadVehicle_Name }, 
  { 0xF113,    4, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadDiagnosticVersion }, 
  { 0xF180,   16, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadBootSoftwareIdentification }, 
  { 0xF186,    1, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadActiveDiagnosticSession }, 
  { 0xF187,   10, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadGeelySparePartNumber }, 
  { 0xF189,   16, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadVehicleManufacturerECUSoftwareVersionNumber }, 
  { 0xF18A,    6, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadSystemSupplierIdentifier }, 
  { 0xF18B,    4, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadECUManufacturingDate }, 

  { 0xF18C,   24, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadECUSerialNumber }, 
  { 0xF190,   17, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadVehicleIdentificationNumber }, 
  { 0xF193,   16, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadsystemSupplierECUHardwareVersionNumber }, 
  { 0xF195,   16, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadsystemSupplierECUSoftwareVersionNumber }, 
  { 0xF197,    8, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadSystemNameOrEngineType }, 
  { 0xF198,   16, { { 0x1F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadRepairShopCodeOrTesterSerialNumber }, 
  { 0xF199,    4, { { 0x1F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadProgrammingOrConfigurationDate }, 
  { 0xF19D,    4, { { 0x1F, 0x05 }, { 0x03, 0x03, 0 } }, ApplDescReadECUInstallationDateDataIdentifier }
};
...
#if defined (DESC_ENABLE_NODE_POWER_CONTROL)
#define __DescNpmSetSleepReady(channel)       (CANNMAPP_vClrWakeupReasonByDiag())
#define __DescNpmSetKeepAwake(channel)        (CANNMAPP_vSetWakeupReasonByDiag())
#endif
...
void DESC_API_CALL_TYPE DescStateInit(void)
{
  ...
  DescSetStateSession(kDescStateSessionDefault); /*ig off->on ENABLE COMMUNICATE,170730*/
...
# endif
  ...
  else
  {
    ...
    /*Modify by LT 20160709,base on 14229-2013 page 25*/
    DescOemFunReqDisNRC();
#else
    if((msg[0] & 0x40) != 0)
    {
...
/*  ********************************************************************************
 * Function name:DescOemControlDefault
...
/*  ********************************************************************************
 * Function name:DescOemControlProgramming
 * Description:Processes the session change request, parametrizing the common processing
 * function.
 * Returns:  nothing
 * Parameter(s):
...
/*  ********************************************************************************
 * Function name:DescOemControlExtendedDiagnostic
 * Description:Processes the session change request, parametrizing the common processing
 * function.
 * Returns:  nothing
 * Parameter(s):
...
/*  ********************************************************************************
 * Function name:DescOemRequestrequestSeed_to_reach_security_level_Unlocked_Level_1
...
/*  ********************************************************************************
 * Function name:DescOemSend_KeysendKey_to_reach_security_level_Unlocked_Level_1
...
static void DESC_API_CALLBACK_TYPE DescOemControlenableRxAndTx(DescMsgContext* pMsgContext)
{
  ...
  if((u16EngSpdValid == 0U)&&(u16Engine>0U)&&(u16Engine!=0xFFFFU)&&(u16Engine!=0xFFFEU))/*Engine is running*/
  {
      ...
      DescProcessingDone();/*20161202,LT*/      
  }
  else
  {   
...
/*  ********************************************************************************
 * Function name:DescOemControldisableRxAndTx
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
static void DescSecurityOnceInitPowerOn(void)
{
  ...
  g_descSecureNrOfAttempts = Diag_nu8SecureNrOfAttempts;
# if defined (DESC_ENABLE_START_SA_TIMER_ON_POWERON)
  g_descSecureTimer        = DescGetTicksOfMs(kDescSeciureTimer);
# else
  g_descSecureTimer        = 0;
# endif

	/*only for geely, 160103*/
...
#  endif
        ...
        g_descNegResCode[DESC_CONTEXT_PARAM_WRAPPER_INDEX(pMsgContext->iContext)] = kDescNrcTimeDelayNotExpired;/*LT modify as Geely Spec3.2 request,20161217*/
        /* Activate brute-force inhibition  */
        g_descSecureTimer = DescGetTicksOfMs(kDescSecureTimer);
	 g_descSecureTimerFlag=True;
        /* Reset the sequence */
        g_descIsKeyAwaited = kDescFalse;/*Geely spec3.3 , after expire time, return the same seed,170812*/
        /* No more retries */
        DescProcessingDone(DESC_CONTEXT_PARAM_WRAPPER_ONLY(pMsgContext->iContext));/*Geely spec3.3 , after expire time, return the same seed,170812*/
        /* exit */
        return;
      }
#  if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
...
# endif
    ...
    else
    {
      ...
      /* Await seed */
	if(g_descSecureTimerFlag==True)
	{
		 /* Finalize the request */
      		DescSecurityAccessSeedReady(DESC_CONTEXT_PARAM_WRAPPER_ONLY(pMsgContext->iContext));
		 g_descSecureTimerFlag=False;
	}
	else
	{
...
/*******************************************************************************
* NAME:              DescOemFunReqDisNRC
*
* CALLED BY:         
* PRECONDITIONS:     
*
* DESCRIPTION:Accroding to the ISO-14229 2013,page 25,should not send the NRC when funtion request in some case
* 
*******************************************************************************/
static void DescOemFunReqDisNRC(void)
{
  /*Modify by LT 20160709,base on 14229-2013 page 25,should not send the NRC when it's funtion req*/
  if((g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.reqType == 0x02)&&((g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.resOnReq &0x02)== 0x02))
  {
    if((g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcServiceNotSupported)||
       (g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcSubfunctionNotSupported)||
       (g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcRequestOutOfRange)||
       (g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcServiceNotSupportedInActiveSession)||
       (g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcSubfunctionNotSupportedInActiveSession)/*Added by Yang Shengli,20170807*/
...
void Desc_vPendingResDataProcess(uint8 u8ServiceID,uint8* u8Res, uint8 u8Len)
{
      DescMsg       msgResponse;
      msgResponse = g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].resData;
     
      
      if(u8ServiceID == 0x31)
      {
      	  g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].resDataLen = 0x01;	
          msgResponse[0]=u8Res[0];
      }
      else if(u8ServiceID == 0x14)
      {
      	  g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].resDataLen = 0x00;	        
      }
