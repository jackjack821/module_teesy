...
CONST(CanNm_LChannelConfigType, CANNM_CONST) CanNm_LChannelConfig[CANNM_NUMBER_OF_CANNM_CHANNELS] = 
{
  
  {
    ...
    200u /* CANNM_TIMEOUT_TIME */, 
    200u /* CANNM_WAIT_BUS_SLEEP_TIME */, 
    160u /* CANNM_REPEAT_MESSAGE_TIME */, 
    0u /* CANNM_REMOTE_SLEEP_IND_TIME */, 
    50u /* CANNM_MSG_CYCLE_TIME */, 
    ...
    5u /* CANNM_IMMEDIATE_NM_TRANSMISSIONS */, 
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <D:\HVACProject\Geely\FE-5DB&7DA\ProjectTools\CANTools\CanGenerateCode\CanNm_Cfg.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <D:\HVACProject\Geely\FE-5DB&7DA\ProjectTools\CANTools\CanGenerateCode\CanNm_Cfg.c> "
