...
#define NM_PRECOMPILE_CRC                    (uint32) 0xCBDA21A8u
...
/* Notify the generic NM that a NM message has been received where a Repeat Message Bit is set */
#define UL_Nm_RepeatMessageIndication        ApplRepeatMsgInd

/* Notification that a NM timeout error occurred */
#define UL_Nm_TxTimeoutException             Ccl_Nm_EnableTxPath
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <D:\HVACProject\Geely\FE-5DB&7DA\ProjectTools\CANTools\CanGenerateCode\Nm_Cfg.h> is different. Please check time and date of generated files!"
  #endif
#else
